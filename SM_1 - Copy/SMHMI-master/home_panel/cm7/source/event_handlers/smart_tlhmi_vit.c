...
void LoadVITModels(void *base)
{
    ...
    s_VITModels[0][MAIN_MENU].len = 364348;
    s_VITModels[0][THERMOSTAT].data = (base + 364352);
    s_VITModels[0][THERMOSTAT].len = 361088;
    s_VITModels[0][SECURITY].data = (base + 725440);
    s_VITModels[0][SECURITY].len = 360420;
    s_VITModels[0][AUDIO_PLAYER].data = (base + 1085888);
    s_VITModels[0][AUDIO_PLAYER].len = 361664;
