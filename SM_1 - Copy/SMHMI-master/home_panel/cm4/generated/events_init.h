...
void home_page_imgbtn_1_event_handler_gest();
void home_page_imgbtn_2_event_handler_gest ();
void home_page_imgbtn_3_event_handler_gest ();
void home_page_imgbtn_4_event_handler_gest ();
void iot_pagee_iot_page_event_handler_gest ();
#ifdef __cplusplus
}
#endif
#endif /* EVENT_CB_H_ */
