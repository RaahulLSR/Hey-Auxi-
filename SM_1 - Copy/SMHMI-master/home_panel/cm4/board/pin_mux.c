...
void BOARD_InitLpuartPins(void)
{
    ...
    IOMUXC_SetPinMux(IOMUXC_GPIO_LPSR_01_LPUART12_RXD, /* GPIO_LPSR_01 is configured as LPUART12_RXD */
                     1U); /* Software Input On Field: Force input path of pad GPIO_AD_25 */
#endif
    /* GPIO configuration on GPIO_SD_B2_00 (pin J15) */
      gpio_pin_config_t gpio10_pinJ15_config = {
          .direction = kGPIO_DigitalOutput,
          .outputLogic = 0U,
          .interruptMode = kGPIO_NoIntmode
      };
      /* Initialize GPIO functionality on GPIO_SD_B2_00 (pin J15) */
      GPIO_PinInit(GPIO10, 9U, &gpio10_pinJ15_config);

      /* GPIO configuration on GPIO_SD_B2_01 (pin J14) */
      gpio_pin_config_t gpio10_pinJ14_config = {
          .direction = kGPIO_DigitalOutput,
          .outputLogic = 0U,
          .interruptMode = kGPIO_NoIntmode
      };
      /* Initialize GPIO functionality on GPIO_SD_B2_01 (pin J14) */
      GPIO_PinInit(GPIO10, 10U, &gpio10_pinJ14_config);

      /* GPIO configuration on GPIO_SD_B2_02 (pin H13) */
      gpio_pin_config_t gpio10_pinH13_config = {
          .direction = kGPIO_DigitalOutput,
          .outputLogic = 0U,
          .interruptMode = kGPIO_NoIntmode
      };
      /* Initialize GPIO functionality on GPIO_SD_B2_02 (pin H13) */
      GPIO_PinInit(GPIO10, 11U, &gpio10_pinH13_config);

      /* GPIO configuration on GPIO_SD_B2_03 (pin E15) */
      gpio_pin_config_t gpio10_pinE15_config = {
          .direction = kGPIO_DigitalOutput,
          .outputLogic = 0U,
          .interruptMode = kGPIO_NoIntmode
      };
      /* Initialize GPIO functionality on GPIO_SD_B2_03 (pin E15) */
      GPIO_PinInit(GPIO10, 12U, &gpio10_pinE15_config);
